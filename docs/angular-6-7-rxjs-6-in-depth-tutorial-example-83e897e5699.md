...
![](img/091219050fe04496f2dcc3299f5b53ee.png)
...
[主题](https://rxjs-dev.firebaseapp.com/guide/subject)是一种特殊类型的可观察对象，观察者也可以订阅它来接收发布的值，但有一点不同:**这些值被多播给许多观察者**。
