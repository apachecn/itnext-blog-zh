...
![](img/9dc6881b1075a772262437c6cf806c03.png)
...
![](img/09013070a5c980ab26f55a9b14847fee.png)
...
更糟糕的是，组件类和功能实用程序类的广泛组合实际上使得*更难理解*，并且在决定什么是对类的有价值的和可重用的修改以及什么应该保持一次性变化时，给开发人员带来了更多的负担:
